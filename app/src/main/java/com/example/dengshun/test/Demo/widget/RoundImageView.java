package com.example.dengshun.test.Demo.widget;
...
public class RoundImageView extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		...
		mIsDrawBorder = a.getBoolean(R.styleable.roundedimageview_is_draw_border, true);
		a.recycle();
	}
	...
	private Bitmap drawableToBitamp(Drawable drawable) {
		...
		int w = getWidth();
		int h = getHeight();
//		System.out.println("Drawable转Bitmap"+":"+w+":"+h);
